...
export const GenesisState = {
  ...
  fromJSON(object: any): GenesisState {
    ...
    message.feePool =
      object.feePool !== undefined && object.feePool !== null ? FeePool.fromJSON(object.feePool) : undefined;
    message.delegatorWithdrawInfos = (object.delegatorWithdrawInfos ?? []).map((e: any) =>
    ...
    message.previousProposer =
      object.previousProposer !== undefined && object.previousProposer !== null
        ...
        : "";
    message.outstandingRewards = (object.outstandingRewards ?? []).map((e: any) =>
      ValidatorOutstandingRewardsRecord.fromJSON(e),
    );
    message.validatorAccumulatedCommissions = (object.validatorAccumulatedCommissions ?? []).map((e: any) =>
      ValidatorAccumulatedCommissionRecord.fromJSON(e),
    );
    message.validatorHistoricalRewards = (object.validatorHistoricalRewards ?? []).map((e: any) =>
      ValidatorHistoricalRewardsRecord.fromJSON(e),
    );
    message.validatorCurrentRewards = (object.validatorCurrentRewards ?? []).map((e: any) =>
      ValidatorCurrentRewardsRecord.fromJSON(e),
    );
    message.delegatorStartingInfos = (object.delegatorStartingInfos ?? []).map((e: any) =>
