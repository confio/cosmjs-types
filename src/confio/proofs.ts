...
export const ExistenceProof = {
  ...
  fromJSON(object: any): ExistenceProof {
    ...
    message.leaf =
      object.leaf !== undefined && object.leaf !== null ? LeafOp.fromJSON(object.leaf) : undefined;
...
export const NonExistenceProof = {
  ...
  fromJSON(object: any): NonExistenceProof {
    ...
    message.key =
      object.key !== undefined && object.key !== null ? bytesFromBase64(object.key) : new Uint8Array();
    message.left =
      object.left !== undefined && object.left !== null ? ExistenceProof.fromJSON(object.left) : undefined;
    message.right =
      object.right !== undefined && object.right !== null ? ExistenceProof.fromJSON(object.right) : undefined;
    return message;
  },
...
export const CommitmentProof = {
  ...
  fromJSON(object: any): CommitmentProof {
    const message = { ...baseCommitmentProof } as CommitmentProof;
    message.exist =
      object.exist !== undefined && object.exist !== null ? ExistenceProof.fromJSON(object.exist) : undefined;
    message.nonexist =
      object.nonexist !== undefined && object.nonexist !== null
        ? NonExistenceProof.fromJSON(object.nonexist)
        : undefined;
    message.batch =
      object.batch !== undefined && object.batch !== null ? BatchProof.fromJSON(object.batch) : undefined;
    message.compressed =
...
export const BatchProof = {
  ...
  fromJSON(object: any): BatchProof {
    const message = { ...baseBatchProof } as BatchProof;
    message.entries = (object.entries ?? []).map((e: any) => BatchEntry.fromJSON(e));
    return message;
  },
...
export const CompressedBatchProof = {
  ...
  fromJSON(object: any): CompressedBatchProof {
    const message = { ...baseCompressedBatchProof } as CompressedBatchProof;
    message.entries = (object.entries ?? []).map((e: any) => CompressedBatchEntry.fromJSON(e));
    message.lookupInners = (object.lookupInners ?? []).map((e: any) => InnerOp.fromJSON(e));
    return message;
  },
